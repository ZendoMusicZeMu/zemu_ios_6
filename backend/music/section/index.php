...
<div id="content">
    ...
    $jsonUrl = $apiurl . 'songs.php?category=' . $section . '&pass=' . $password . '&originalicon=true';
    ...
    if ($page > 1) {
        echo '<a href="?data=' . $section . '&sec=' . $sec . '&page=' . ($page - 1) . '"><button><</button></a>';
    } else {
        echo '<a class="disabled"><button><</button></a>';
    }
    echo '<a href="?data=' . $section . '&sec=' . $sec . '&page=' . $page . '" class="active"><button>' . $page . '</button></a>';
    if ($page < $totalPages) {
        echo '<a href="?data=' . $section . '&sec=' . $sec . '&page=' . ($page + 1) . '"><button>></button></a>';
    } else {
        echo '<a class="disabled"><button>></button></a>';
